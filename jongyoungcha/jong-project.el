...
(defun jong-project-scroll-up-log-frame()
  (interactive)
  (let ((parent-frame (selected-frame))
        )
    (call-interactively 'jong-project-focus-log-window)
    (ignore-errors (scroll-up 15))
    (select-frame-set-input-focus parent-frame)
    )
  )

(defun jong-project-scroll-down-log-frame()
  (interactive)
  (let ((parent-frame (selected-frame))
        )
    (call-interactively 'jong-project-focus-log-window)
...
(defun jong-project-switch-buffer-log-frame()
  (interactive)
  (let ((parent-frame (selected-frame))
        )
    (call-interactively 'jong-project-focus-log-window)
    (ignore-errors (call-interactively 'switch-to-buffer))
    (select-frame-set-input-focus parent-frame)
    )
  )
...
(defun jong-project-compile-project ()
  (interactive)
  (call-interactively 'jong-common-reload-dir-locals)
